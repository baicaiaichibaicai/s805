...
#if defined(CONFIG_CORTINA_REFERENCE) || defined(CONFIG_CORTINA_REFERENCE_B) || defined(CONFIG_CORTINA_REFERENCE_S) || defined(CONFIG_CORTINA_PON) || defined(CONFIG_CORTINA_WAN) || defined(CONFIG_CORTINA_BHR) || defined(CONFIG_CORTINA_REFERENCE_Q) || defined(CONFIG_CORTINA_FUTURE)
	gpio_direction_output(GPIO_USB_VBUS_POWER_0, 0);
	gpio_set_value(GPIO_USB_VBUS_POWER_0, 1);
#else
	gpio_direction_output(GPIO_USB_VBUS_POWER_0, 0);
