 ...
 *  igb_setup_led. This is a function pointer entry point called by drivers.
 **/
...
/**
 *  e1000_rar_set_igb - Sets a receive address register
 *  @hw: pointer to the HW structure
 ...
 **/
void e1000_rar_set_igb(struct e1000_hw *hw, u8 *addr, u32 index)
{
...
{
	return igb_read_pba_string_generic(hw, pba_num, pba_num_size);
}
