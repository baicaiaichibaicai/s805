...
#else /* CONFIG_FERRET */
extern int __kc_netif_set_xps_queue_i40e(struct net_device *, struct cpumask *, u16);
#define netif_set_xps_queue(_dev, _mask, _idx) __kc_netif_set_xps_queue_i40e((_dev), (_mask), (_idx))
#endif /* CONFIG_FERRET */
#else /* CONFIG_XPS */
...
#else /* CONFIG_FERRET */
#ifdef CONFIG_PCI_IOV
extern int __kc_pci_vfs_assigned_i40e(struct pci_dev *dev);
#else
static inline int __kc_pci_vfs_assigned_i40e(struct pci_dev __always_unused *dev)
{
	return 0;
}
#endif /* CONFIG_PCI_IOV */
#define pci_vfs_assigned(dev) __kc_pci_vfs_assigned_i40e(dev)
#endif /* CONFIG_FERRET */
...
#else
#define dma_set_mask_and_coherent(_p, _m) __kc_dma_set_mask_and_coherent_i40e(_p, _m)
extern int __kc_dma_set_mask_and_coherent_i40e(struct device *dev, u64 mask);
#endif /* CONFIG_FERRET */
#else /* >= 3.13.0 */
