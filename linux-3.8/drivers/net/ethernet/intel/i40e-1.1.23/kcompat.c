...
int __kc_netif_set_xps_queue(struct net_device *dev, struct cpumask *mask,
			     u16 index)
#else
int __kc_netif_set_xps_queue_i40e(struct net_device *dev, struct cpumask *mask,
				 u16 index)
#endif /* CONFIG_FERERT */
{
...
#else
int __kc_pci_vfs_assigned_i40e(struct pci_dev __maybe_unused *dev)
#endif /* CONFIG_FERRET */
{
...
#else
int __kc_dma_set_mask_and_coherent_i40e(struct device *dev, u64 mask)
#endif /* CONFIG_FERRET */
{
