...
#define pci_request_regions _kc_pci_request_regions_igb
extern int _kc_pci_request_regions_igb(struct pci_dev *pdev, char *res_name);
#endif
...
#define BMCR_PWRDOWN            0x0800  /* Power down                  */
