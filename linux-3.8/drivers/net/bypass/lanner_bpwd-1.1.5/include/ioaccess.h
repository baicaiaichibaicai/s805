...
int i2c_smbus_write_block_data(int fd, unsigned char i2c_address,
                            ...
                            unsigned char *pec_byte);
#else
int lanner_bypass_write_byte(int fd, unsigned char i2c_address, unsigned char i2c_command,
                        int pec, unsigned char *pec_byte);
int lanner_bypass_write_byte_data(int fd, unsigned char i2c_address,
                                unsigned char i2c_register, unsigned char value);

int lanner_bypass_read_byte_data(int fd, unsigned char i2c_address,
                             unsigned char i2c_register, unsigned char *ret_val, int inhibit_err);

int lanner_bypass_read_word_data(int fd, unsigned char i2c_address,
                            unsigned char i2c_register, unsigned short *ret_val);

int lanner_bypass_read_block_data(int fd, unsigned char i2c_address,
                            unsigned char i2c_register, unsigned char ret_array[],
                            unsigned char *pec_byte);

int lanner_bypass_write_block_data(int fd, unsigned char i2c_address,
                            unsigned char i2c_register, unsigned char ret_array[],
                            unsigned char *pec_byte);
#endif
