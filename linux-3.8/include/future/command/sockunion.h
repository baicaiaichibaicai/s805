...
//long sockunion_accept (int sock, union sockunion *);
//long sockunion_socket (union sockunion *su);
...
int sockopt_reuseaddr (long);
int sockopt_reuseport (long);
...
const char *
__inet_ntop (int family, const void *addrptr, char *strptr, size_t len);
...
//int
//__inet_pton (int family, const char *strptr, void *addrptr);

int
__inet_aton (const char *cp, struct in_addr *inaddr);
