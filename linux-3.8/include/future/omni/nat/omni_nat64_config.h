...
extern int fw_nat64_proc_write(struct file *file, const char __user *buffer,
    unsigned long count, void *data);
extern int fw_nat64_proc_read(char *page, char **start, off_t off, int count,
    int *eof, void *data);

extern rwlock_t nat64_rw_lock;
#endif
