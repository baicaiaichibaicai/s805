...
SFHASHFCN * IPSsfhashfcn_new(int mem_method, void * memory, int nrows );
SFHASHFCN * sfhashfcn_new(int mem_method, void * memory, int nrows );
void sfhashfcn_free(int mem_method, void * memory, SFHASHFCN * p );
