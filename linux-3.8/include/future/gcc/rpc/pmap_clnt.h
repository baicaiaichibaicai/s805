/*  $Id: pmap_clnt.h,v 1.1 2007/01/24 11:57:48 mdjoo Exp $ */
...
__BEGIN_DECLS extern bool_t pmap_set __P((u_long, u_long, u_int, int));
...
extern enum clnt_stat pmap_rmtcall __P((struct sockaddr_in *,
					...
					xdrproc_t, caddr_t,
					xdrproc_t, caddr_t, struct timeval, u_long *));
extern enum clnt_stat clnt_broadcast __P((u_long, u_long, u_long,
					  xdrproc_t, char *,
					  xdrproc_t, char *,
					  bool_t(*)__P((caddr_t, struct sockaddr_in *))));
extern u_short pmap_getport __P((struct sockaddr_in *, u_long, u_long, u_int));
__END_DECLS
