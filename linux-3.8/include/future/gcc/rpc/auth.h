/*  $Id: auth.h,v 1.1 2007/01/24 11:57:48 mdjoo Exp $ */
...
__BEGIN_DECLS extern bool_t xdr_des_block __P((XDR *, des_block *));
__END_DECLS
/*
...
typedef struct __rpc_auth {
	...
	/* validate varifier */
	int (*ah_validate) __P((struct __rpc_auth *, struct opaque_auth *));
	/* refresh credentials */
 ...
 *	int *aup_gids;
 */
__BEGIN_DECLS struct sockaddr_in;
extern AUTH *authunix_create __P((char *, int, int, int, int *));
extern AUTH *authunix_create_default __P((void));
extern AUTH *authnone_create __P((void));
extern AUTH *authdes_create __P((char *, u_int, struct sockaddr_in *, des_block *));
__END_DECLS
