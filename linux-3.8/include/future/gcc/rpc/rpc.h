/*  $Id: rpc.h,v 1.1 2007/01/24 11:57:48 mdjoo Exp $ */
...
#include "pmap_clnt.h"	/* generic pmap stuff */
...
__BEGIN_DECLS extern struct rpcent *getrpcbyname __P((char *));
...
extern int registerrpc __P((int, int, int, char *(*)__P((char[UDPMSGSIZE])), xdrproc_t, xdrproc_t));
