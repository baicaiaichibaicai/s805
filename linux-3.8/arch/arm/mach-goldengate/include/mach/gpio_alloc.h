...
#elif defined(CONFIG_FTW_1000) || defined(CONFIG_FTW_1000_V2)

#define GPIO_FACTORY_DEFAULT    GPIO1_BIT5
#define GPIO_SYS_RDY_LED0       GPIO1_BIT18
#define GPIO_SYS_RDY_LED1       GPIO1_BIT19
#define GPIO_SYS_RDY_LED2       GPIO1_BIT20
#define GPIO_WIFI_DISABLE       GPIO2_BIT8
#define GPIO_WIFI_SW            GPIO2_BIT10
#define GPIO_FLASH_WP_N			GPIO2_BIT21
#define GPIO_USB_VBUS_POWER_0   GPIO2_BIT24
#define GPIO_PCIE_RESET         GPIO2_BIT28
#define GPIO_WAN_INT            GPIO2_BIT29
...
#elif defined(CONFIG_FTM_100S)

#define GPIO_FACTORY_DEFAULT    GPIO1_BIT5
#define GPIO_SYS_RDY_LED0       GPIO1_BIT18
#define GPIO_WIFI_DISABLE       GPIO2_BIT8
#define GPIO_WIFI_SW            GPIO2_BIT9
#define	GPIO_GPS0_SHUTDOWN_N	GPIO2_BIT14
#define	GPIO_KPD0_PWR_ON		GPIO2_BIT15
#define	GPIO_LTE0_PWR_EN		GPIO2_BIT16
#define	GPIO_GPS1_SHUTDOWN_N	GPIO2_BIT17
#define	GPIO_KPD2_PWR_ON		GPIO2_BIT18
#define	GPIO_LTE3_PWR_EN		GPIO2_BIT19
#define GPIO_FLASH_WP_N			GPIO2_BIT21
#define GPIO_USB_VBUS_POWER_0   GPIO2_BIT24
#define GPIO_USB_VBUS_POWER_1   GPIO2_BIT25
#define GPIO_LTE_RESET			GPIO2_BIT27
#define GPIO_PCIE_RESET         GPIO2_BIT28
#define GPIO_WAN_INT            GPIO2_BIT29
...
#elif defined(CONFIG_FTM_NICO2)

#define GPIO_FACTORY_DEFAULT    GPIO1_BIT5
#define GPIO_SYS_RDY_LED        GPIO1_BIT18
#define	GPIO_VPN_PW_LED			GPIO1_BIT23
#define	GPIO_SW_DETECT			GPIO1_BIT24
#define	GPIO_CPU_PWR_HOLD		GPIO1_BIT25
#define	GPIO_CPU_PWR_CLK		GPIO1_BIT26
#define	GPIO_GPS_SHUTDOWN_N		GPIO2_BIT14
#define	GPIO_KPD_PWR_ON			GPIO2_BIT15
#define GPIO_USB_VBUS_POWER_0   GPIO2_BIT24
#define GPIO_USB_VBUS_POWER_1   GPIO2_BIT25
#define GPIO_PCIE_RESET         GPIO2_BIT28
#define GPIO_WAN_INT            GPIO2_BIT29
...
#elif defined(CONFIG_CORTINA_WAN) || defined(CONFIG_CORTINA_REFERENCE_Q) || defined(CONFIG_CORTINA_FUTURE)
