...
static void __init goldengate_map_io(void)
{
	...
	/* BUG#40270: Enlarge the noncache memory size to 64MB */
...
static struct i2c_board_info i2c_board_infos[] __initdata = {
	...
	|| defined(CONFIG_CORTINA_WAN) || defined(CONFIG_CORTINA_FUTURE)
	{
...
#warning CUSTOM_BOARD_REVIEW_ME
	 ...
	 },
	{
	 ...
	 defined(CONFIG_CORTINA_REFERENCE_Q) || defined(CONFIG_CORTINA_FUTURE)
...
static int cs75xx_irq_set_wake(struct irq_data *data, unsigned int on)
{
...
void __init gic_init_irq(void)
{
	...
	gic_arch_extn.irq_set_wake = cs75xx_irq_set_wake;
...
static inline void goldengate_reset(char mode, const char *cmd)
{
#ifndef CONFIG_CORTINA_FPGA
	/*
